...
@author: DaCapo
reference:https://github.com/Da-Capo/Entity-Relation-SVM
"""
...
#    读取实体
    ...
    for entity in apf_root.iter('entity'):
        ...
        ne_subtype =  entity.attrib["SUBTYPE"] if 'SUBTYPE' in entity.attrib else ""
...
#    关系
    ...
    for relation in apf_root.iter('relation'):
        ...
        rel_subtype = relation.attrib["SUBTYPE"] if 'SUBTYPE' in relation.attrib else ""
